...
class Settings(BaseSettings):
    ...
    # Application
    APP_NAME: str = "OnTask AI Summary Service"
    ...
    # Daily Summary Generation Settings (Phase 10)
    SUMMARY_TEMPERATURE: float = 0.2
    # How many times to ask the model to correct itself after a validation
    # failure (a fabricated member id or an untraceable number) before giving
    # up on the AI and returning the deterministic template narrative instead.
    SUMMARY_MAX_VALIDATION_RETRIES: int = 1
